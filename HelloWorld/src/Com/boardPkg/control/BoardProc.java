...
public class BoardProc {
	...
	public void execute() {
		while (true) {
			...
			System.out.println("1. 작성  2. 단건조회 3. 전체 조회 4. 종료");
			int menu = sc.nextInt();
			sc.nextLine();
			if (menu == 1) {
				writeBoard();
	...
	public void writeBoard() {
		...
		int boardNo = sc.nextInt(); sc.nextLine(); //nextInt에 엔터가 포함되어 있기 때문에 엔터를 소진할 수 있는 nextLine 를 추가해줘야함.
...
//		}
	public void deleteBoard() {
		...
		int boardNo = sc.nextInt();
		Board board = service.deleteBoard(boardNo);
